...
function Tab(props) {
    return (react_1.default.createElement("button", __assign({}, props.tabProps, { role: "tab", type: "button", "aria-selected": props.isActive, title: props.title, className: "tab".concat(props.isActive ? ' active' : ''), onClick: props.onSelect }),
        props.title,
...
function TabAddButton(props) {
    return (react_1.default.createElement("button", { type: "button", onClick: props.onClick, className: "tab-add", title: "Create new tab" },
